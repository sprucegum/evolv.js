...
windows = [
	...
	[{"type":"textWindow","title":"About JTK" ,"text":"JTK is an experimental canvas application framework. It is built for the Chromium browser and is designed to stress the CPU."},{}],
];
